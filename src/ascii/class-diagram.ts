...
import type { ClassDiagram, ClassNode, ClassMember, ClassRelationship, RelationshipType } from './parsers/class-types.js'
  ...
  for (const rel of diagram.relationships) {
    ...
    if (rel.label) {
      ...
      for (let lineIdx = 0; lineIdx < lines.length; lineIdx++) {
        ...
        const paddedWidth = displayWidth(paddedLine)

...
// MIX values inlined from beautiful-mermaid's theme.ts (not in its public exports).
// Keep these in sync if the upstream ratios change — see src/ascii/LICENSE-NOTICE.md.
const MIX = {
  line: 50,
  nodeStroke: 20,
  arrow: 85,
